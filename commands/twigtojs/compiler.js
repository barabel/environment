...
module.exports = (id, tokens, pathToTwig) => {
    ...
    const output = [
        `let twig = require("${pathToTwig}").twig;`,
        `let template = twig({id: ${JSON.stringify(id)}, data: ${JSON.stringify(parsedTokens)}, precompiled: true, allowInlineIncludes: true, rethrow: true, });`,
